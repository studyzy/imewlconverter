...
namespace ICSharpCode.SharpZipLib.Encryption
{
    ...
    /// </summary>
    public class PkzipClassicEncryptCryptoTransform : PkzipClassicCryptoBase, ICryptoTransform
    {
        /// <summary>
    ...
    /// </summary>
    public class PkzipClassicDecryptCryptoTransform : PkzipClassicCryptoBase, ICryptoTransform
    {
        /// <summary>
