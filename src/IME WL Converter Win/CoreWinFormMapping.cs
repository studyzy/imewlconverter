...
internal class CoreWinFormMapping
{
    ...
    private void form_Closed(object sender, EventArgs e)
    {
        ...
        {
            if (!propMapping.ContainsKey(propertyInfo.Name)) continue;
    ...
    {
        if (imeFormMapping == null) InitImportFormMapping();
        if (formPropertityMapping == null) InitImportPropertityMapping();
